...
class AfPanTests(unittest.TestCase):
    def test_split_single(self):
        self.assertEquals([[1]], AfPanGenerator.groupToIO("1",1))
    def test_split_two_inputs(self):
        self.assertEquals([[1,2]], AfPanGenerator.groupToIO("1:2",2))
    def test_split_two_inputs_two_outputs(self):
        self.assertEquals([[1,2],[3,4]], AfPanGenerator.groupToIO("1:2:3:4",2))
    def test_split_three_inputs(self):
        self.assertEquals([[1,2,3]], AfPanGenerator.groupToIO("1:2:3",3))
    def test_split_three_inputs_two_outputs(self):
        self.assertEquals([[1,2,3],[4,5,6]], AfPanGenerator.groupToIO("1:2:3:4:5:6",3))

    def test_mixerStringToChannels(self):
